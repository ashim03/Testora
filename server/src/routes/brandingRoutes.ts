...
router.put("/", authenticate, authorize("SUPER_ADMIN", "TEACHER"), validateRequest(brandingSchema as never), branding.put);
router.post("/logo/clear", authenticate, authorize("SUPER_ADMIN", "TEACHER"), branding.clearLogo);
